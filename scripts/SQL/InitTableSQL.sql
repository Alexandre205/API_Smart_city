...
CREATE TABLE vehicule(
    ...
    utilisateur INTEGER REFERENCES utilisateur(id) NOT NULL
);
...
CREATE TABLE trajet (
    ...
    vehicule VARCHAR REFERENCES vehicule(immatriculation) NOT NULL
);
...
CREATE TABLE demande (
    ...
    coordonnee_depart POINT NOT NULL,
    coordonnee_arrivee POINT NOT NULL,
    demandeur INTEGER REFERENCES utilisateur(id) NOT NULL
);
